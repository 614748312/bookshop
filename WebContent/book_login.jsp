		  ...
		  <div class="login_main">
			...
			<div class="login_right">
				...
				<div class="login_main_in">
					<div class="login_row">
						<input type="text" name="" value="" class="login_input login_inp1" placeholder="用户名" />
						<div class="bbb1" id="bbb1"></div>
					</div>
					<div class="login_row">
						<input type="password" name="" value="" class="login_input login_inp2" placeholder="密码" />
						<div class="bbb1" id="bbb2"><span id="bb2"></span></div>
					</div>
					<div class="login_valid">
						<span class="login_valid_nm">验证码：</span>
						<input type="password" name="" value="" class="login_input login_inp3" placeholder="" />
					    <div class="btn111"><img alt="点击图片" src="" onclick=""></div>
					</div>
					<div class="login_tr">
						<input type="submit" class="ltn" id="login_ltn" value="登陆" onclick="javascript:window.location.href='book_index.jsp'">
					</div>
