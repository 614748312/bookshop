 ...
 <!--最顶部链接-->
    <div class="tools">
        <div class="head" name="顶部链接">
            <ul class="head_nav">
                <li class="my_bookshop">
                    <a  class="menu_btn" href="#" name="我的书籍屋" id="a_channel" onmouseover="showgaoji('a_channel','nav_mybookshop')"
                    onmouseout="hideotherchannel('a_channel','nav_mybookshop')">我的书籍屋</a>
                   <ul class="head_card_list" id="nav_mybookshop" onmouseover="showgaoji('a_channel','nav_mybookshop')"
            ...
            <div class="head_welcome">
                 <span id="nickname">
                                                欢迎光临奈布书城，请
                    <a href="book_login.jsp" name="登录" class="login_link">登录</a>
                    <a href="book_register.jsp" name="注册" class="register_link">成为会员</a>
                </span>
            </div>
        </div>
    </div>
