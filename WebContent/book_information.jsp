...
<div id="text_center">
    ...
    <div class="now_position">
        <p>当前位置：<a href="book_index.jsp">首页</a>/<a href="book_newbooks.jsp">新书上架</a>/<a href="book_information.jsp">斗罗大陆</a></p>
    </div>
    <!--左侧作者图片信息-->
    <div class="author_left">
        ...
        <div class="author_small">
            <ul>
                <li>
                    <img src="lq/img/new_books/books_img/25228702-1_l_7.jpg" width="100">
                </li>
                <li>
                    <img src="lq/img/new_books/books_img/25228702-1_l_7.jpg" width="100">
                </li>
    ...
    <div class="author_right">
        ...
        <div class="author_introduce">
            <p>
                ...
                跳崖明志时却发现没有死，反而以另外一个身份来到了另一
                个世界，一个属于武魂的世界，名叫斗罗大陆。这里没有魔法
                ，没有斗气，没有武术，却有神奇的武魂。这里的每个人，
                在自己六岁的时候，都会在武魂殿中令武魂觉醒。武魂有
                动物，有植物，有器物
                ，武魂可以辅助人们的日常生活。而其中一些特别出色
                的武魂却可以用来修炼并进行战斗，这个职业，是斗
                罗大陆上最为强大也是最荣耀的职业“魂师”。
            </p>
        </div>
        <div class="author_books_money">
            ...
            <form>
            <span>
              	  数量:   <input type="text" class="num" placeholder="0">
            </span>
                <a class="btn btn-lg btn-primary num_add">+</a>
                <a class="btn btn-lg btn-danger num_del num_disable" >-</a>
                <br>
                <input   type="button" class="btn btn-a btn-lg btn-danger num_cart" value="加入购物车"  onclick='location.href=("book_shopcart.jsp")'>
                <input   type="submit" class="btn btn-a btn-lg btn-danger num_buy" value="立即购买">
           </form>
        </div>
    ...
    <div class="author_buttom">
        ...
        <div class="other_img">
            <ul>
                <li>
                    <img src="lq/img/new_books/books_img/25228702-1_l_7.jpg">
                    <a>斗罗大陆</a><br>
                    <span><i class="fa fa-jpy"></i>50.00</span>
                </li>
                <li>
                    <img src="lq/img/new_books/books_img/25228702-1_l_7.jpg">
                    <a>斗罗大陆</a>
