...
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>/mcy/css/myorder.css" />
<link rel="stylesheet" type="text/css"
	...
	<div class="mymuen">
		<div class="mymuen_list">
			...
			<div class="mymuen_list_n">
				<ul>
					<li><a href="book_myorder.jsp" class="mymuen_list_n1">我的订单</a>
					</li>
					<li><a href="book_myinfo.jsp">我的信息</a></li>
					<li><a href="book_myadress.jsp">我的地址</a></li>
		...
		<div class="myoder">
			...
			<div class="myoder_title">
				<ul>
					<li><a class="s1" href="">我的订单</a></li>
					<li><a class="" href="">未发货</a></li>
					<li><a class="" href="">已发货</a></li>
				</ul>
			</div>
			<div class="myoder_form">
				...
				<div class="myoder_form_c">
					...
					<div class="shopping_r">
						<ul>
							<li class="f1"><a href="#"><img src="mcy/img/shu1.jpg"
									alt="" width="60px" height="60px"></a></li>
