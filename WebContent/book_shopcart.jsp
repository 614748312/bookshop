	...
	<body>
		...
		<div id="" class="w960">
			...
			<ul id="" class="shopping_title">
				<li class="f1">
					<a id="" class="checknow " href="#" dd_name="全选"></a>
					全选
				</li>
				<li class="f2">商品信息</li>
				<li class="f3">单价（元）</li>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							<tr  class="bb_none tree_first ">
								<td class="row1">
									<a class="fn-product-check checknow check_on" href="#">选中</a>
								</td>
								<td class="row_img">
									<a href="#" dd_name="查看详情页"><img src="mcy/img/shu1.jpg" width="80px" height="80px" /></a>
								</td>
								<td class="row_name">
									<a href="#">书名书名书名书名书名书名书名书名书名书名书名书名书名书名书名书名</a>
								</td>
								<td class="row4">
									<span>￥50.00</span>
								</td>
								<td class="fn-count-tip row3">
									<span class="amount updatecount " data-value="1">
									    <a dd_name="减少数量" href="#">-</a>
									    <input  data-value="1" value="1" type="text"/>
									    <a dd_name="增加数量" href="#">+</a>
								    </span>
								</td>
								<td class="row4">
									<span>￥50.00</span>
								...
								<td class="row5">
									<span><a class="fn-remove-product" href="#" dd_name="删除这本书籍">删除</a></span>
								</td>
							</tr>
							<tr  class="bb_none tree_first ">
								<td class="row1">
				...
				<div style="position: static; bottom: -20px; z-index: 101; width: 100%; left: 0px;">
					<div class="shopping_total" >
						<div class="shopping_total_right">
							<a class="total_btn fn-checkout unable" href="book_fillorder.jsp"  dd_name="结算">结&nbsp;&nbsp;算</a>							
						</div>
						<div class="shopping_total_left" ">
							<a  href="#" class="checknow fn-checkall" dd_name="全选">选中</a>全选
							<a  href="#" class="fn-batch-remove" dd_name="批量删除按钮">批量删除</a>
							<span>已选择<font color="red">0</font>件</span>									
						</div>
					</div>
				</div>
			</div>
