...
<div id="text_center">
    <div class="book_cort">
        ...
        <div class="now_position">
            <p>当前位置：<a href="book_index.jsp">首页/</a><a href="book_index.jsp">教育/</a><a href="book_index.jsp">语文</a>
            <p>搜索结果如下：</p>
        </div>
        <!--搜索结果-->
        <div class="book_cort_">
            <div class="book_cort_one">
                <div class="book_cort_img">
                    <img src="lq/img/author/linxi/24145765-1_b_9.jpg">
                </div>
                <div class="book_cort_text">
                    <span>林夕：任你行陈奕迅推荐！华语乐坛金牌词人</span><br>
                    <span><i class="fa fa-jpy">38.00</i></span>
                    <p>★陈奕迅推荐！书名来自林夕作词、陈奕迅演唱的热门金曲《任我行》。
                        ★华语乐坛金牌词人、畅销经典《原来你非不快乐》作者林夕全新力作！近百篇禅理散文，
                        剖析现实生活中你我不得不面对的自由与孤独。
                    </p>
                    <input type="button" class="zbox-btn zbox-btn-blue zbox-btn-outlined" id="toastBtn"  value="加入购物车">
                    <input type="button" class="zbox-btn zbox-btn-blue zbox-btn-outlined" value="立即购买">
                </div>
            </div>
            <div class="book_cort_one">
                <div class="book_cort_img">
                ...
                <div class="book_cort_text">
                    ...
                    <input type="button" class="zbox-btn zbox-btn-blue zbox-btn-outlined" value="加入购物车">
                    <input type="button" class="zbox-btn zbox-btn-blue zbox-btn-outlined" value="立即购买">
                </div>
            </div>
            <div class="book_cort_one">
