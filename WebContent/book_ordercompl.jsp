...
<html>
	...
	<body>
		...
		<div class="logo_line1" name="我的购物车流程">
			<div class="w960">
				<div class="shopping_prcedure" style="background: url(mcy/img/procedure_bg3.png) 0 0 no-repeat;">
		...
		<div class="comple_order">
			<div class="comple_tishi">
				<span>亲，您已经支付成功了！是否继续<a href="book_index.jsp">逛逛</a>?</span>
				<span>或者查看<a href="book_myorder.jsp">我的订单</a>?</span>
			</div>			
